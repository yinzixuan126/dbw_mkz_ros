...
* This should ONLY be run on a fresh install of [Ubuntu 18.04.x Desktop](http://releases.ubuntu.com/18.04/ubuntu-18.04-desktop-amd64.iso)/[Ubuntu 16.04.x Desktop](http://releases.ubuntu.com/16.04/ubuntu-16.04.4-desktop-amd64.iso)/[Ubuntu 14.04.5 Desktop](http://releases.ubuntu.com/14.04/ubuntu-14.04.5-desktop-amd64.iso).
